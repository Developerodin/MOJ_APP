...
export const WorkExperienceCard = () => {
  return (
    ...
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                          <div>
                            <span style={{fontSize:"18px",fontWeight:500}}>General Manager</span>
                          </div>
                    ...
                    <div style={{marginTop:"3px"}}>
                      <span style={{fontSize:"15px",color:"#575757",fontWeight:500}}>Hotel King's palace , Jaipur</span>
                    </div>

                    <div style={{marginTop:"3px"}}>
                      <span style={{fontSize:"15px",fontWeight:500}}>Full Time . Jan 2023 - Mar 2024 (1 year)</span>
                    </div>
