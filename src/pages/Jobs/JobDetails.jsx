          ...
          <div style={{ marginTop: "30px" }}>
            ...
            <IonIcon style={{color:"#395CFF",fontSize:"24px"}} icon={bookmark} />
                ...
                >
                  ...
                  >
                    {data && data.job_title} {`(${data && data.department})`}
                  </span>
                  <span style={{ fontSize: "12px", color: "#395CFF" }}>
                    {data && timeAgo(data.created_at)}
                  </span>
                </div>
                ...
                >
                  ...
                  >
                    <img src={book} alt="Globe Icon" style={{}} />
            ...
            <div>
              <ul>
                ...
                {data && data.job_type === "Full Time" ? (
                  <li>{data && data.job_type}</li>
                ) : (
                  <li>{`${data && data.job_type} (start time : ${
                    data && data.start_time
                  } ,end time : ${data && data.end_time} )`}</li>
                )}
