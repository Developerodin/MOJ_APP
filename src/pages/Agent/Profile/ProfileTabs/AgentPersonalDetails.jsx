...
export const AgentPersonalDetails = () => {
  ...
  const UpdateUser = async () => {
    ...
    try {
      const url = `${Base_url}auth/agent_update`;
      ...
      formData1.append("gst_number", formData.gstin || "");
      formData1.append("gst_name", formData.gstFirmName || "");
  ...
  useEffect(() => {
    ...
    let profileDetails = {
      ...
      gstFirmName: userDetails.gst_name,
    };
