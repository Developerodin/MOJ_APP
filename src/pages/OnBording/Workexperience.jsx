    ...
    <IonPage>
      <IonContent>
        ...
        <div style={{ padding: "20px" }}>
          <ProfileHeaders
            icon={<IonIcon icon={bagHandleOutline} style={{ fontSize: "24px", color: "#395CFF" }} />}
            ...
            <div style={{ marginTop: "20px" }}>
              ...
              >
                {selectedLanguage === "English"
                  ...
                  : "क्या आपके पास कार्य का अनुभव है या आप नये हैं?"}
              </label>
              <IonSelect
          ...
          <div style={{ padding: "5px" }}>
            {userWorkExperience !== "fresher" && experienceData ? (
              experienceData &&
              ...
              <div style={{ marginTop: "30px" }}>
                <span>
                  {selectedLanguage === "English"
                    ...
                    : "कोई कार्य अनुभव रिकॉर्ड उपलब्ध नहीं है"}
                </span>
              </div>
            )}
          </div>
        ...
        {userWorkExperience === "experienced" && (
          <div
            style={{
              width: "100%",
              display: "flex",
