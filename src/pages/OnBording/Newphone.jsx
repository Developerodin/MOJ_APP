      ...
      <IonContent>
        <div style={{ padding: "20px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <IonIcon onClick={handleBackClick} icon={chevronBackOutline} style={{ fontSize: "24px" }} />
          ...
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
            ...
            {!isMobile && (
              <div style={{ display: "flex", justifyContent: "center", alignItems: "center", marginTop: "50px" }}>
                <CustomBtn1 fun={handleBtnClick} title={"Continue"} loading={loading} />
              </div>
            )}
          </div>
        </div>
        ...
        {isMobile && (
          <div style={{ width: "100%", display: "flex", justifyContent: "center", alignItems: "center", marginTop: '33vh' }}>
            <CustomBtn1 fun={handleBtnClick} title={selectedLanguage === "English" ? "Continue" : "जारी रखना"} loading={loading} />
          </div>
        )}
      </IonContent>
    </IonPage>
